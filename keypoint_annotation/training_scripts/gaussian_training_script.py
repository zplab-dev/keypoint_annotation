...
def train_model(covariate, max_val, downscale=1, image_shape=(960,96), mask_error=False, total_epoch_num=25):
    ...
    if os_type == 'Darwin':
        ...
        save_dir = '/mnt/lugia_array/Laird_Nicolette/deep_learning/keypoint_detection/new_api/production_dataloader_test/new_kp_maps/1D_gaussian/'+str(total_epoch_num)+'_epochs/'+project_name
